    ...
    >
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-[60%_40%] gap-12 items-start">
        ...
        <div>
          ...
          Маслянский Вячеслав Борисович — врач-флеболог, специализирующийся на диагностике и лечении острых и хронических заболеваний вен. Современные методики и индивидуальная тактика лечения.
Внимательно разбирает жалобы, особенности образа жизни и наследственные факторы. Доступно объясняет пациенту, что происходит с венами и какие варианты лечения подходят именно ему.
В работе придерживается современного доказательного подхода с акцентом на профилактику осложнений и улучшение качества жизни.
        ...
        <div className="flex justify-center md:justify-end md:mt-10">
            ...
            <div className="p-6">
              ...
              Специалист по диагностике и лечению заболеваний вен. Индивидуальный подход, современные методики и многолетний опыт позволяют достигать оптимальных результатов в лечении.
              </p>
            </div>
          </div>
        </div>
